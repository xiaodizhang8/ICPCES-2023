    ...
    def instantiate(self, var_mapping, init_facts, init_assignments,
        ...
        if effects:
            if metric:
                ...
                cost = 1
            return PropositionalAction(name, precondition, effects, cost, effects_with_delete, all_precondition)
        else:
            return None


class PropositionalAction:
    def __init__(self, name, precondition, effects, cost, effects_with_delete, all_precondition):
        self.name = name
        self.precondition = precondition
        self.add_effects = []
        self.del_effects = []
        ...
        self.all_precondition = all_precondition
