...
def parse_probabilistic_task(domain_pddl, task_pddl):
    ...
    task_name, task_domain_name, task_requirements, objects, init, all_possible_initial, init_true, init_false, disjunction_inits, initial_probability_groups, threshold, goal, use_metric = parse_probabilistic_task_pddl(task_pddl, type_dict, predicate_dict)
    assert domain_name == task_domain_name
    requirements = Requirements(sorted(set(
                domain_requirements.requirements +
                task_requirements.requirements)))
    ...
    return ProbabilisticTask(
        domain_name, task_name, requirements, types, objects,
        predicates, functions, init, all_possible_initial, init_true, init_false, initial_probability_groups, threshold, goal, actions, axioms, use_metric, disjunction_inits, constants)
